...
public class PrefActivity extends PreferenceActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CheckBoxPreference chbp = new CheckBoxPreference(this);
        chbp.setKey("chbp");
        chbp.setTitle("chbp");
        chbp.setSummaryOn("Description of checkbox 1 on");
        chbp.setSummaryOff("Description of checkbox 1 off");

        rootScreen.addPreference(chbp);
